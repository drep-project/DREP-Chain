...
*/
func (accountapi *AccountApi) CreateAccount(password string) (string, error) {
	if !accountapi.Wallet.IsOpen() {
	...
	addrStr := crypto.EthToDrep(newAaccount.Address)
	return addrStr, nil
}
...
/*
 ...
 params:
 return:  Failure returns the reason for the error, and success returns no information
 example:   curl http://localhost:10085 -X POST --data '{"jsonrpc":"2.0","method":"account_lockAccount","params":["DREP518b3fefa3fb9a72753c6ad10a2b68cc034ec391"], "id": 3}' -H "Content-Type:application/json"
 response:
	 {"jsonrpc":"2.0","id":3,"result":null}
*/
func (accountapi *AccountApi) LockAccount(addr string) error {
	...
	return accountapi.Wallet.Lock(&ethAddr)
...
/*
 ...
 params:
	...
	2. password
 return: Failure returns the reason for the error, and success returns no information
 example:   curl http://localhost:10085 -X POST --data '{"jsonrpc":"2.0","method":"account_unlockAccount","params":["DREP518b3fefa3fb9a72753c6ad10a2b68cc034ec391", "123456"], "id": 3}' -H "Content-Type:application/json"
 response:
	 {"jsonrpc":"2.0","id":3,"result":null}
*/
func (accountapi *AccountApi) UnlockAccount(addr string, password string) error {
	ethAddr := crypto.DrepToEth(addr)
	if !accountapi.Wallet.IsOpen() {
		return ErrClosedWallet
	}

	return accountapi.Wallet.UnLock(&ethAddr, password)
}
...
/*
 ...
 example:   curl -H "Content-Type: application/json" -X post --data '{"jsonrpc":"2.0","method":"account_transfer","params":["DREP3ebcbe7cb440dd8c52940a2963472380afbb56c5","DREP3ebcbe7cb440dd8c52940a2963472380afbb56c5","0x111","0x110","0x30000",""],"id":1}' http://127.0.0.1:10085
 response:
	 {"jsonrpc":"2.0","id":1,"result":"0x3a3b59f90a21c2fd1b690aa3a2bc06dc2d40eb5bdc26fdd7ecb7e1105af2638e"}
*/
func (accountapi *AccountApi) Transfer(from, to string, amount, gasprice, gaslimit *common.Big, data common.Bytes) (string, error) {
	fromAddress := crypto.DrepToEth(from)
	toAddress := crypto.DrepToEth(to)

	if gasprice.ToInt().Uint64() < blockmgr.DefaultGasPrice {
		gasprice.SetMathBig(*new(big.Int).SetUint64(blockmgr.DefaultGasPrice))
	}

	nonce := accountapi.poolQuery.GetTransactionCount(&fromAddress)
	tx := types.NewTransaction(toAddress, (*big.Int)(amount), (*big.Int)(gasprice), (*big.Int)(gaslimit), nonce)
	sig, err := accountapi.Wallet.Sign(&fromAddress, tx.TxHash().Bytes())
	if err != nil {
		return "", err
	}
	tx.Sig = sig
...
/*
 ...
 params:
    ...
    7. nonce
 return: transaction hash
 example:   curl -H "Content-Type: application/json" -X post --data '{"jsonrpc":"2.0","method":"account_transferWithNonce","params":["DREP3ebcbe7cb440dd8c52940a2963472380afbb56c5","DREP3ebcbe7cb440dd8c52940a2963472380afbb56c5","0x111","0x110","0x30000","",1],"id":1}' http://127.0.0.1:10085
 response:
	 {"jsonrpc":"2.0","id":1,"result":"0x3a3b59f90a21c2fd1b690aa3a2bc06dc2d40eb5bdc26fdd7ecb7e1105af2638e"}
*/
func (accountapi *AccountApi) TransferWithNonce(from, to string, amount, gasprice, gaslimit *common.Big, data common.Bytes, nonce uint64) (string, error) {
	fromAddress := crypto.DrepToEth(from)
	toAddress := crypto.DrepToEth(to)
...
/*
 ...
 return: transaction hash
 example:
	curl -H "Content-Type: application/json" -X post --data '{"jsonrpc":"2.0","method":"account_setAlias","params":["DREP3ebcbe7cb440dd8c52940a2963472380afbb56c5","AAAAA","0x110","0x30000"],"id":1}' http://127.0.0.1:10085
response:
	{"jsonrpc":"2.0","id":1,"result":"0x5adb248f2943e12fb91c140bd3d0df6237712061e9abae97345b0869c3daa749"}
*/
func (accountapi *AccountApi) SetAlias(srcAddr string, alias string, gasprice, gaslimit *common.Big) (string, error) {
	ethAddress := crypto.DrepToEth(srcAddr)

	nonce := accountapi.poolQuery.GetTransactionCount(&ethAddress)
	t := types.NewAliasTransaction(alias, (*big.Int)(gasprice), (*big.Int)(gaslimit), nonce)
	sig, err := accountapi.Wallet.Sign(&ethAddress, t.TxHash().Bytes())
	if err != nil {
		return "", err
	}
	t.Sig = sig
...
/*
 ...
 response:
	 {"jsonrpc":"2.0","id":1,"result":"0x3a3b59f90a21c2fd1b690aa3a2bc06dc2d40eb5bdc26fdd7ecb7e1105af2638e"}
*/
func (accountapi *AccountApi) VoteCredit(from, to string, amount, gasprice, gaslimit *common.Big) (string, error) {
	fromAddress := crypto.DrepToEth(from)
	toAddress := crypto.DrepToEth(to)

	nonce := accountapi.poolQuery.GetTransactionCount(&fromAddress)
	tx := types.NewVoteTransaction(toAddress, (*big.Int)(amount), (*big.Int)(gasprice), (*big.Int)(gaslimit), nonce)
	sig, err := accountapi.Wallet.Sign(&fromAddress, tx.TxHash().Bytes())
	if err != nil {
		return "", err
	}
...
/*
 ...
 params:
	...
	6. 备注
 return: transaction hash
 example:   curl -H "Content-Type: application/json" -X post --data '{"jsonrpc":"2.0","method":"account_cancelVoteCredit","params":["DREP3ebcbe7cb440dd8c52940a2963472380afbb56c5","DREP3ebcbe7cb440dd8c52940a2963472380afbb56c5","0x111","0x110","0x30000"],"id":1}' http://127.0.0.1:10085
 response:
	 {"jsonrpc":"2.0","id":1,"result":"0x3a3b59f90a21c2fd1b690aa3a2bc06dc2d40eb5bdc26fdd7ecb7e1105af2638e"}
*/
func (accountapi *AccountApi) CancelVoteCredit(from, to string, amount, gasprice, gaslimit *common.Big) (string, error) {
	fromAddress := crypto.DrepToEth(from)
	toAddress := crypto.DrepToEth(to)

	nonce := accountapi.poolQuery.GetTransactionCount(&fromAddress)
	tx := types.NewCancelVoteTransaction(toAddress, (*big.Int)(amount), (*big.Int)(gasprice), (*big.Int)(gaslimit), nonce)
	sig, err := accountapi.Wallet.Sign(&fromAddress, tx.TxHash().Bytes())
	if err != nil {
		return "", err
	}
...
/*
 ...
 return: transaction hash
 example:   curl -H "Content-Type: application/json" -X post --data '{"jsonrpc":"2.0","method":"account_candidateCredit","params":["DREP3ebcbe7cb440dd8c52940a2963472380afbb56c5","0x111","0x110","0x30000","{\"Pubkey\":\"0x020e233ebaed5ade5e48d7ee7a999e173df054321f4ddaebecdb61756f8a43e91c\",\"Node\":\"enode://3f05da2475bf09ce20b790d76b42450996bc1d3c113a1848be1960171f9851c0@149.129.172.91:44444\"}"],"id":1}' http://127.0.0.1:10085
 response:
	 {"jsonrpc":"2.0","id":1,"result":"0x3a3b59f90a21c2fd1b690aa3a2bc06dc2d40eb5bdc26fdd7ecb7e1105af2638e"}
*/
func (accountapi *AccountApi) CandidateCredit(from string, amount, gasprice, gaslimit *common.Big, data string) (string, error) {
	fromAddress := crypto.DrepToEth(from)
	...
	if !bytes.Equal(crypto.PubkeyToAddress(cd.Pubkey).Bytes(), fromAddress.Bytes()) {
		return "", nil
	}
...
/*
 ...
 response:
	 {"jsonrpc":"2.0","id":1,"result":"0x3a3b59f90a21c2fd1b690aa3a2bc06dc2d40eb5bdc26fdd7ecb7e1105af2638e"}
*/
func (accountapi *AccountApi) CancelCandidateCredit(from string, amount, gasprice, gaslimit *common.Big) (string, error) {
	fromAddress := crypto.DrepToEth(from)
	nonce := accountapi.poolQuery.GetTransactionCount(&fromAddress)
...
/*
 ...
 example:
	curl -H "Content-Type: application/json" -X post --data '{"jsonrpc":"2.0","method":"account_readContract","params":["DREPec61c03f719a5c214f60719c3f36bb362a202125","DREPecfb51e10aa4c146bf6c12eee090339c99841efc","0x6d4ce63c"],"id":1}' http://127.0.0.1:10085
 response:
	 {"jsonrpc":"2.0","id":1,"result":""}
*/
func (accountapi *AccountApi) ReadContract(from, to string, input common.Bytes) (common.Bytes, error) {
	fromAddress := crypto.DrepToEth(from)
	toAddress := crypto.DrepToEth(to)

	header := accountapi.EvmService.Chain.GetCurrentHeader()
	tx := types.NewTransaction(toAddress, new(big.Int).SetUint64(0), &big.Int{}, new(big.Int).SetUint64(params.MinGasLimit), 0)
	tx.Data.Data = input
...
/*
 ...
 example:
	curl -H "Content-Type: application/json" -X post --data '{"jsonrpc":"2.0","method":"account_estimateGas","params":["DREPec61c03f719a5c214f60719c3f36bb362a202125","DREPecfb51e10aa4c146bf6c12eee090339c99841efc","0x6d4ce63c","0x110","0x30000"],"id":1}' http://127.0.0.1:10085
 response:
	 {"jsonrpc":"2.0","id":1,"result":"0x5d74aba54ace5f01a5f0057f37bfddbbe646ea6de7265b368e2e7d17d9cdeb9c"}
*/
func (accountapi *AccountApi) EstimateGas(from string, amount *common.Big, data common.Bytes, to string) (uint64, error) {
	fromAddress := crypto.DrepToEth(from)
	toAddress := crypto.DrepToEth(to)
	...
	header := accountapi.EvmService.Chain.GetCurrentHeader()
	tx := types.NewTransaction(toAddress, amount.ToInt(), new(big.Int).SetUint64(blockmgr.DefaultGasPrice), new(big.Int).SetUint64(params.MinGasLimit), 0)
	tx.Data.Data = data
...
/*
 ...
 return: transaction hash
 example:
	curl -H "Content-Type: application/json" -X post --data '{"jsonrpc":"2.0","method":"account_executeContract","params":["DREPec61c03f719a5c214f60719c3f36bb362a202125","DREPecfb51e10aa4c146bf6c12eee090339c99841efc","0x6d4ce63c","0x110","0x30000"],"id":1}' http://127.0.0.1:10085
 response:
	 {"jsonrpc":"2.0","id":1,"result":"0x5d74aba54ace5f01a5f0057f37bfddbbe646ea6de7265b368e2e7d17d9cdeb9c"}
*/
func (accountapi *AccountApi) ExecuteContract(from string, to string, input common.Bytes, gasprice, gaslimit *common.Big) (string, error) {
	fromAddress := crypto.DrepToEth(from)
	toAddress := crypto.DrepToEth(to)

	nonce := accountapi.poolQuery.GetTransactionCount(&fromAddress)
	t := types.NewCallContractTransaction(toAddress, input, &big.Int{}, (*big.Int)(gasprice), (*big.Int)(gaslimit), nonce)
	sig, err := accountapi.Wallet.Sign(&fromAddress, t.TxHash().Bytes())
	if err != nil {
		return "", err
	}
	t.Sig = sig
...
/*
 ...
 return: transaction hash
 example:
 	curl -H "Content-Type: application/json" -X post --data '{"jsonrpc":"2.0","method":"account_createCode","params":["DREP3ebcbe7cb440dd8c52940a2963472380afbb56c5","","0x111","0x110","0x30000"],"id":1}' http://127.0.0.1:10085
 response:
	 {"jsonrpc":"2.0","id":1,"result":"0x9a8d8d5d7d00bbe0eb1b9431a13a7219008e352241b751b177bfb29e4e75b0d1"}
*/
func (accountapi *AccountApi) CreateCode(from string, byteCode common.Bytes, gasprice, gaslimit *common.Big) (string, error) {
	fromAddress := crypto.DrepToEth(from)
...
*/
func (accountapi *AccountApi) DumpPrivkey(address string) (*secp256k1.PrivateKey, error) {
	ethAddress := crypto.DrepToEth(address)
	...
	node, err := accountapi.Wallet.GetAccountByAddress(&ethAddress)
	if err != nil {
		return nil, err
	}
...
/*
 ...
 response:
	 {"jsonrpc":"2.0","id":3,"result":"0x270f4b122603999d1c07aec97e972a2ddf7bd8b5bfe3543c10814e6a19f13aaf"}
*/
func (accountapi *AccountApi) DumpPubkey(address string) (*secp256k1.PublicKey, error) {
	ethAddress := crypto.DrepToEth(address)
	if !accountapi.Wallet.IsOpen() {
		return nil, ErrClosedWallet
	}
...
/*
 ...
 return: private key
 example:
	curl http://localhost:10085 -X POST --data '{"jsonrpc":"2.0","method":"account_sign","params":["DREP3ebcbe7cb440dd8c52940a2963472380afbb56c5", "0x00001c9b8c8fdb1f53faf02321f76253704123e2b56cce065852bab93e526ae2"], "id": 3}' -H "Content-Type:application/json"
...
*/
func (accountapi *AccountApi) Sign(address string, hash common.Bytes) (common.Bytes, error) {
	ethAddress := crypto.DrepToEth(address)
	sig, err := accountapi.Wallet.Sign(&ethAddress, hash)
	if err != nil {
		return nil, err
	}
	return sig, nil
...
/*
 ...
 example:
	curl http://localhost:10085 -X POST --data '{"jsonrpc":"2.0","method":"account_generateAddresses","params":["DREP3ebcbe7cb440dd8c52940a2963472380afbb56c5"], "id": 3}' -H "Content-Type:application/json"

response:
	 {"jsonrpc":"2.0","id":3,"result":""}
*/
func (accountapi *AccountApi) GenerateAddresses(address string) (*RpcAddresses, error) {
	ethAddress := crypto.DrepToEth(address)

	privkey, err := accountapi.Wallet.DumpPrivateKey(&ethAddress)
	if err != nil {
		return nil, err
	}
...
*/
func (accountapi *AccountApi) ImportKeyStore(path, password string) ([]string, error) {

	address, err := accountapi.Wallet.ImportKeyStore(path, password)

	strAddrs := make([]string, 0, len(address))

	for _, addr := range address {
		strAddrs = append(strAddrs, crypto.EthToDrep(addr))
	}
...
response:
	 {"jsonrpc":"2.0","id":3,"result":"DREP748eb65493a964e568800c3c2885c63a0de9f9ae"}
*/
func (accountapi *AccountApi) ImportPrivkey(privBytes common.Bytes, password string) (string, error) {
	priv, _ := secp256k1.PrivKeyFromScalar(privBytes)
	node, err := accountapi.Wallet.ImportPrivKey(priv, password)
	if err != nil {
		return "", err
	}
	return crypto.EthToDrep(node.Address), nil
}
