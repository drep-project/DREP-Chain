...
// BlockMgrAPI is block management for processing block chain partial upper logic.
type BlockMgrAPI struct {
	blockMgr  *BlockMgr
	dbService *database.DatabaseService
}

// SendRawTransaction api used to send signed transactions
...
// response: {"jsonrpc":"2.0","id":1,"result":"0xf30e858667fa63bc57ae395c3f57ede9bb3ad4969d12f4bce51d900fb5931538"}
...
// GasPrice api used to get the recommended value of gasprice given by the system.
// params:
// 1. Query address
...
// response: {'jsonrpc': '2.0', 'id': 3, 'result': 1000000000}
func (blockMgrApi *BlockMgrAPI) GasPrice() (*big.Int, error) {
	return blockMgrApi.blockMgr.gpo.SuggestPrice()
}

// GetPoolTransactions api used to get trading information in the trading pool.
// params:
// 1. Query address
...
// GetTransactionCount api used to get the total number of transactions issued by the address.
// params:
// 1. Query address
// return: All transactions in the pool
...
// GetPoolMiniPendingNonce used to get the smallest Nonce in the pending queue
// params:
// 1. Query address
...
// GetTxInPool api used to checks whether the transaction is in the trading pool and, if so, returns the transaction
// params:
