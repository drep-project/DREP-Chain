...
var (
    ErrGoChain = "failed to go to chain: "
    ErrCreateAccount = "failed to create new accounts: "
    ErrGetAccount = "failed to check accounts: "
    ErrCheckBalance = "check balance error: "
