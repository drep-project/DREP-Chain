...
func NewExecuteTransactionContext(blockContext *BlockExecuteContext, chainstore store.StoreInterface, gasPool *utils.GasPool, from *crypto.CommonAddress, tx *types.Transaction) *ExecuteTransactionContext {
